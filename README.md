...
- модель Booking создает связи между User и TimeSlot на определенную дату (связь с Room здесь лишняя - потом исключу).
...
- /rooms/availability (get) вывод информации о свободных и занятых слотах на дату для любого пользователя.
